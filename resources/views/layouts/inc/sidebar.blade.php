<div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
    <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
        <div class="kt-aside__brand-logo">
            <a href="{{ url('/') }}">
                <img alt="Logo" src="{{ asset('media/logos/ati-app.jpg') }}" />
            </a>
        </div>
            ...
            <ul class="kt-menu__nav">
                ...
                {{-- @permission(['view-purchase', 'view-product', 'view-supplier', 'view-storage-transaction']) --}}
                    <li class="kt-menu__section ">
                        <h4 class="kt-menu__section-text">{{ __('Casting e-Checksheet') }}</h4>
                        <i class="kt-menu__section-icon flaticon-more-v2"></i>
                    </li>
                {{-- @endpermission --}}
                {{-- @permission('view-purchase') --}}
                    <li class="kt-menu__item @if(Request::is('melting*')) kt-menu__item--here @endif" aria-haspopup="true">
                        <a href="{{ route('melting.index') }}" class="kt-menu__link">
                            <i class="kt-menu__link-icon fa fa-dumpster-fire"></i>
                            <span class="kt-menu__link-text">{{ __('Melting') }}</span>
                        </a>
                    </li>
                {{-- @endpermission --}}
                {{-- @permission('view-purchase') --}}
                    <li class="kt-menu__item @if(Request::is('pouring*')) kt-menu__item--here @endif" aria-haspopup="true">
                        <a href="{{ route('pouring.index') }}" class="kt-menu__link">
                            <i class="kt-menu__link-icon fa fa-fill-drip"></i>
                            <span class="kt-menu__link-text">{{ __('Pouring') }}</span>
                        </a>
                    </li>
                {{-- @endpermission --}}
